        ...
        <div class="wrapper">
            ...
            <nav id="sidebar" class="nav-sidebar">
                <ul class="list-unstyled components" id="accordion">
                    <div class="user-profile">
                        <div class="dropdown user-pro-body">
                            <div class="mb-2"><a href="#" class="" data-toggle="" aria-haspopup="true" aria-expanded="false"> <span class="font-weight-semibold">{{ Session::get('username')}}</span>  </a>
                                <br><span class="text-gray">Recruiter</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <li class="{{Route::is('recruiter.create_test') ? 'active':''}}">
                        <a href="{{route('recruiter.create_test')}}" class=" wave-effect"><i class="fa fa-plus mr-2"></i> Create Test</a>
                    </li>
                    <li class="{{Route::is('recruiter.tests') ? 'active':''}}">
                        <a href="{{route('recruiter.tests')}}" class=" wave-effect"><i class="fa fa-toggle-right mr-2"></i> Tests</a>
                    </li>
