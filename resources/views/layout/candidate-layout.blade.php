                        ...
                        <div class="dropdown text-center selector">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
                                <div class="text-center">
                                    ...
                                    <span class="text-center user-semi-title text-dark">Candidate</span>
                ...
                <ul class="list-unstyled components" id="accordion">
                    <div class="user-profile">
                        <div class="dropdown user-pro-body">
                            <div><img src="{{asset('assets\images\faces\female\25.jpeg')}}" alt="user-img" class="img-circle"></div>
                            <div class="mb-2"><a href="#" class="" data-toggle="" aria-haspopup="true" aria-expanded="false"> <span class="font-weight-semibold">{{ Session::get('username')}}</span>  </a>
                                <br><span class="text-gray">Candidate</span>
                            </div>
                        </div>
                    </div>
